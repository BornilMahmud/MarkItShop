...
import { normalizeGoogleDriveLink, toDisplayImageSrc } from "@/helpers/image-url";
      ...
      <div className="flex flex-col gap-y-7 xl:ml-5 max-xl:px-5 w-full">
        ...
        <div>
          <label className="form-control w-full max-w-lg">
            <div className="label">
              <span className="label-text">Image URL (Google Drive link supported):</span>
            </div>
            <input
              type="text"
              ...
              onChange={(e) =>
                setProduct({ ...product, mainImage: normalizeGoogleDriveLink(e.target.value) })
              }

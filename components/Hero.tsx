      ...
      <div className="grid grid-cols-3 items-center justify-items-center px-10 gap-x-10 max-w-screen-2xl mx-auto h-full max-lg:grid-cols-1 max-lg:py-10 max-lg:gap-y-10">
        <div className="flex flex-col gap-y-5 max-lg:order-last col-span-2">
          <h1 className="text-6xl text-white font-bold mb-3 max-xl:text-5xl max-md:text-4xl max-sm:text-3xl">
            {siteConfig.name.toUpperCase()} FOR EVERYDAY TECH
          </h1>
          <p className="text-white max-sm:text-sm">
            Discover modern electronics, smart accessories, and reliable campus-ready devices with a professional shopping and admin experience.
          </p>
          <div className="flex gap-x-1 max-lg:flex-col max-lg:gap-y-1">
            <Link href="/shop" className="bg-white text-blue-600 text-center font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-gray-100">
              BUY NOW
            </Link>
          </div>
        </div>
